...
public class Megaman extends Human{
    ...
    // Ve Animation cua Megaman thay vi la hinh chu nhat
    @Override
                ...
                if(getState() == NOBEHURT && (System.nanoTime()/10000000)%2!=1)
                {
                    ...
                    if(getIsLanding()){
                        ...
                        if(getSpeedX() > 0){
                            ...
                            if(runForwardAnim.getCurrentFrame() == 1) runForwardAnim.setIgnoreFrames(0);
                        }else if(getSpeedX() < 0){
                            ...
                            if(runBackAnim.getCurrentFrame() == 1) runBackAnim.setIgnoreFrames(0);
                        }else{
                            if(getDirection() == RIGHT_DIR){
                                if(isShooting){
...
//                setDirection(RIGHT_DIR);
    ...
    public void stopRun(){
        ...
        runForwardAnim.reset();
        runBackAnim.reset();
        runForwardAnim.unIgnoreFrames(0);
        runBackAnim.unIgnoreFrames(0);
    }
    ...
    public void attack(){
        ...
        if(!isShooting && !getIsDicking()){
            ...
            // Cac ham set cho vien dan dung vi tri nong sung
            if(getDirection() == LEFT_DIR) {
                bullet.setSpeedX(-10);
